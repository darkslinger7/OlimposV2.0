...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2025 a las 06:48:36
...
INSERT INTO `clientes` (`id_cliente`, `id_usuario`, `hotel`, `apartamento`, `fecha_registro`, `id_hotel`, `id_habitacion`) VALUES
(1, 43, NULL, NULL, '2025-11-27', 1, 1);
...
INSERT INTO `habitaciones` (`id_habitacion`, `id_hotel`, `numero`, `tipo`, `capacidad`, `precio`, `estado`, `tiene_televisor`, `tiene_wifi`, `tiene_jacuzzi`, `tiene_aire`, `tiene_minibar`) VALUES
(1, 1, 'A-101', 'Doble', 2, 25.00, 'disponible', 1, 1, 0, 1, 0),
(2, 5, 'B-1205', 'Suite', 6, 325.00, 'disponible', 1, 1, 1, 1, 1),
(3, 5, 'B-0101', 'Doble', 2, 35.00, 'disponible', 1, 1, 0, 1, 0),
(4, 5, 'B-0102', 'Matrimonial', 2, 60.00, 'disponible', 1, 1, 1, 1, 1);
...
INSERT INTO `historial_pagos` (`id_pago`, `id_hotel`, `id_admin`, `monto`, `fecha_pago`) VALUES
(1, 4, 38, 300.00, '2025-11-26 21:47:57');
...
(36, 'Sofia Rodriguez', 'sofiarod', '31802716', 'sofiarod397@gmail.com', '+584120549159', 'V-31802716', 2, '11/11/2025', NULL, 1, NULL, 0.00),
(37, 'Johan Torres', 'johantor', '31804754', 'alvaradojohan112@gmail.com', '+584143552866', 'V-31804754', 2, '11/11/2025', NULL, 2, NULL, 0.00),
(38, 'Juan Mendoza', 'juangpt', '30227089', 'juan.a.m.b.9@gmail.com', '+584145666286', 'V-30227089', 2, '11/11/2025', NULL, 4, 1, 300.00),
(39, 'Pablo Acevedo', 'pabloac', '30019476', 'pablo36115@gmail.com', '+584128700012', 'V-30019476', 2, '11/11/2025', NULL, 3, NULL, 0.00),
(41, 'Yarismar Lucena', 'ramsy', '8514218', 'yarismarlv2002@gmail.com', '+584120200331', 'V-30509875', 2, '26/11/2025', NULL, 5, NULL, 0.00),
(42, 'Juan Hernandez', 'juanher', '1234', 'juanher@gmail.com', '+58412031456', 'V-25641574', 3, '26/11/2025', NULL, 5, 1, 200.00),
(43, 'Pedro Perez', 'pedrito', '1234', 'pedrito@gmail.com', '+584264548952', 'V-11062388', 4, '27/11/2025', 1, 1, NULL, 0.00);
...
--
ALTER TABLE `habitaciones`
  MODIFY `id_habitacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
